...
return (
    ...
    <h3 className="text-[18px] leading-[30px] text-headingColor font-bold "> Shivam Kakodiya</h3>
...
<button onClick={()=> setTab('settings')} className={` ${tab=='settings' && 'bg-primaryColor text-white font-normal'}py-2
px-5 rounded-md
text-headingColor font-semibold text-[16px] leading-7

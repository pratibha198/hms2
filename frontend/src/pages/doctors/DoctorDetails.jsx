      ...
      <div className="grid md:grid-cols-3 gap-[50px]">
        <div className="md:col-span-2">
          <div className="flex items-center gap-5">
            ...
            <div>
              <span className='bg-[#CCF0F3] text-irisBlueColor pt-1 px-6 lg:py-2 lg:px-6 text-[12px]
              ...
              A skilled and compassionate surgeon committed to providing exceptional patient care, utilizing advanced techniques for safe, effective treatments. 
              </p>
            </div>
          </div>

import { formateDate } from '../../utils/formulateDate'
    ...
    <div>
        ...
        <div className="mt-12">
            ...
            <ul className='pt-4 md:p-5'>
                {
                    qualifications?.map((item,index)=>(<li key ={index} className='flex flex-col sm:flx-row sm:justify-between sm:items-end md:gap-5 mb-[30px]'>
                    <div>
        ...
        <div className="mt-12">
            ...
            <ul className="grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5">
                ...
                {/* <li className='p-4 rounded bg-[#fff9ea]'>
                    <span className='text-yellowColor text-[15px] leading-6 font-semibold'>
                    {formateDate('12-07-2010')} - {formateDate('09-13-2014')}
                    </span>
                    <p className='text-[16px] leading-5 font-medium text-textColor'>
                        Sr. Surgeon
                    </p>
